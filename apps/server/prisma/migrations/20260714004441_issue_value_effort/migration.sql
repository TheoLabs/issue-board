...
INSERT INTO "new_Issue" ("body", "createdAt", "domainId", "id", "labels", "parentId", "planId", "priority", "projectId", "screenId", "status", "title", "type", "updatedAt", "version") SELECT "body", "createdAt", "domainId", "id", "labels", "parentId", "planId", "priority", "projectId", "screenId", "status", "title", "type", "updatedAt", "version" FROM "Issue";
DROP TABLE "Issue";
